...
@Documented
@Constraint(validatedBy = { NegativeOrZero.NegativeOrZeroValidator.class })
@Target({ ElementType.METHOD, ElementType.FIELD, ElementType.ANNOTATION_TYPE, ElementType.CONSTRUCTOR,
        ElementType.PARAMETER, ElementType.TYPE_USE })
@Retention(RetentionPolicy.RUNTIME)
public @interface NegativeOrZero {

    String message() default "{com.iot.platform.NegativeOrZero.message}";
    ...
    public class NegativeOrZeroValidator implements ConstraintValidator<NegativeOrZero, Comparable> {
