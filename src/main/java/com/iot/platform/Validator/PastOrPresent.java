...
@Documented
@Constraint(validatedBy = { PastOrPresent.PastOrPresentValidator.class })
@Target({ ElementType.METHOD, ElementType.FIELD, ElementType.ANNOTATION_TYPE, ElementType.CONSTRUCTOR,
        ElementType.PARAMETER, ElementType.TYPE_USE })
@Retention(RetentionPolicy.RUNTIME)
public @interface PastOrPresent {

    String message() default "{com.iot.platform.PastOrPresent.message}";
    ...
    public class PastOrPresentValidator implements ConstraintValidator<PastOrPresent, Object> {
