...
@Documented
@Constraint(validatedBy = { Positive.PositiveValidator.class })
@Target({ ElementType.METHOD, ElementType.FIELD, ElementType.ANNOTATION_TYPE, ElementType.CONSTRUCTOR,
        ElementType.PARAMETER, ElementType.TYPE_USE })
@Retention(RetentionPolicy.RUNTIME)
public @interface Positive {

    String message() default "{com.iot.platform.Positive.message}";
    ...
    public class PositiveValidator implements ConstraintValidator<Positive, Comparable> {
