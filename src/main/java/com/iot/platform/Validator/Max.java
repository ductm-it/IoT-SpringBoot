...
@Documented
@Constraint(validatedBy = { Max.MaxValidator.class })
...
public @interface Max {
    ...
    String message() default "{com.iot.platform.Max.message}";
    ...
    public class MaxValidator implements ConstraintValidator<Max, Comparable> {
