...
@Documented
@Constraint(validatedBy = { PositiveOrZero.PositiveOrZeroValidator.class })
@Target({ ElementType.METHOD, ElementType.FIELD, ElementType.ANNOTATION_TYPE, ElementType.CONSTRUCTOR,
        ElementType.PARAMETER, ElementType.TYPE_USE })
@Retention(RetentionPolicy.RUNTIME)
public @interface PositiveOrZero {

    String message() default "{com.iot.platform.PositiveOrZero.message}";
    ...
    public class PositiveOrZeroValidator implements ConstraintValidator<PositiveOrZero, Comparable> {
